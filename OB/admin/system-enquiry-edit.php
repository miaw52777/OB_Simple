<?include_once("../dbAccess/CommFunc.php");include_once("../dbAccess/conn.php");	include_once("../dbAccess/SystemManageFunc.php");include('./adsecure.php');if(!is_login()){	header("Location: index.php");	exit;}  $rule = get_System_Management_item_Select_Rule('NAME','線上詢問');$returnMsg = get_System_Management($rule);$system_enquiry_id = getSQLResultInfo($returnMsg['DATA'],'id');$system_enquiry_valid = getSQLResultInfo($returnMsg['DATA'],'valid');?><!DOCTYPE html>
...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-bordered menu-shadow">
  <div class="main-menu-content">
    <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
      <li class="nav-item"><a href="products-category.php"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">產品類別</span><span class="tag tag tag-primary tag-pill float-xs-right mr-2">11</span></a> </li>
      ...
      <li class="nav-item"><a href="business-enquiry.php"><i class="icon-cash"></i><span class="menu-title">商情中心</span></a></li>
      ...
      <li class="nav-item active"><a href="system.php"><i class="icon-android-settings"></i><span class="menu-title">系統管理</span></a></li>
  ...
  <div class="content-wrapper">
    <div class="content-header row padding-bottom-20">
      <div class="content-header-left col-md-6 col-xs-12">
        <h2 class="content-header-title mb-0">系統管理</h2>
        <div class="row breadcrumbs-top">
          <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="system.php">系統管理</a></li>
              <li class="breadcrumb-item active">線上詢問</li>
            </ol>
          </div>
        </div>
      </div>
    </div>	<form class="form form-horizontal" action="system-enquiry-edit-submit.php" method="post">	
              ...
              <div class="card-body collapse in">
                <div class="card-block card-dashboard padding-lr-20 padding-bottom-20 padding-top-20">
                  ...
                  <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-success"> <i class="icon-check2"></i> 儲存 </button>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card-body collapse in">
                <div class="card-block card-dashboard padding-lr-20 padding-bottom-20 padding-top-20">
                    ...
                    <tbody>
                      <tr>
                        <td><div class="card-block">
                            <div class="icheck1">
                              <fieldset>								<?
                                 if($system_enquiry_valid == 'T')									{										$is_checked = 'checked';									}									else									{							  											$is_checked = 'unchecked';									}																		echo '<input type="checkbox" id="input-2" name="system_enquiry_valid" '.$is_checked.'>';																?>
                              </fieldset>
                            </div>
                          </div></td>
                        <td>線上詢問</td>
                  ...
                  <table class="table table-striped table-bordered">
                    ...
                    <tbody>					<?							$system_id = $_GET['systemid'];										$rule = get_System_Management_item_udata_Select_Rule('ID',$system_id);					$rule .= get_System_Management_item_udata_Select_Rule('NAME','MAIL');					$returnMsg = get_System_Management_udata($rule);							if($returnMsg['RESULT'])					 {						 			 						 while($temp = mysql_fetch_assoc($returnMsg['DATA']))													{									$tmplateForlist=' <tr>										<td><span class="col-md-9">											  <input name="mail[CONTENT][]" type="text" class="form-control" placeholder="Email" value=":CONTENT">										  <input name="mail[SEQ][]" type="text" class="form-control" placeholder="Email" value=":SEQ" hidden>										  </span></td>									  </tr>';													$sourceStr = array(":SEQ", ":CONTENT");							$replaceStr = array($temp['seq'],$temp['content']);							echo str_replace($sourceStr, $replaceStr,$tmplateForlist);							}					  }					  else					  {						  echo $returnMsg['MSG'];					  }					  					  echo '<input name="system_id" type="text" class="form-control" placeholder="Email" value="'.$system_id.'" hidden>';					?>
