...
/* get download format record by d_id*/
$rule = get_DownloadFormat_Select_Rule('D_ID',$d_id);	
$querySpecresult = get_DownloadFormat_List($rule);
$d_category = getSQLResultInfo($querySpecresult,'category');
$d_common = getSQLResultInfo($querySpecresult,'common');
?>
        ...
        <div class="row breadcrumbs-top">
          <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="products-edit.php"><? echo $Action; ?>產品</a></li>
              <li class="breadcrumb-item active">3D 下載格式名稱</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-xs-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">3D 下載格式名稱</h4>
              ...
              <div class="card-body collapse in">
                <div class="card-block padding-lr-20">
                  <form class="form form-horizontal" action="download-format-submit.php" method="post">
                    <div class="form-body padding-top-40">
                      <div class="form-group row">
                        <label class="col-md-3 label-control" for="projectinput1">格式名稱</label>
                        <div class="col-md-9">
                          <input type="text" id="projectinput1" class="form-control" placeholder="格式名稱" name="category" value="<? echo $d_category; ?>">
                        </div>
                      </div>
                      
                      <div class="form-group row">
                        <label class="col-md-3 label-control" for="projectinput9">常用格式</label>
                        <div class="col-md-9">
                          <div class="card-block">
                            <div class="icheck1">
                              <fieldset>								<?									if($d_common == 'T') $is_check = 'checked';									else $is_check = 'unchecked';										
                                 echo '<input type="checkbox" id="input-2" name="common" '.$is_check.'>';								?>
                                <label for="input-2">常用格式</label>
                              </fieldset>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="form-actions">
                      ...
                      <button type="submit" class="btn btn-success"> <i class="icon-check2"></i> 					  <? 						if($Action == "刪除") echo $Action;						else echo '儲存';					  ?> </button>					<? 						 echo '<input type="hidden" name="action" value="'.$Action.'"/>';						 echo '<input type="hidden" name="prod_id" value="'.$Product_id.'"/>';						 echo '<input type="hidden" name="d_id" value="'.$d_id.'"/>';						?>						
                    </div>
                  </form>
                </div>
              </div>
