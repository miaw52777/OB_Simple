<?include_once("../dbAccess/conn.php");	include_once("../dbAccess/ProductCategoryFunc.php");include('./adsecure.php');if(!is_login()){	header("Location: index.php?page=".$_SERVER['REQUEST_URI']);	exit;} $queryResult = get_Products_Category_List('%');$LevelRootCnt = getLevel1CategoryCount($queryResult);?><!DOCTYPE html>
        ...
        <div class="row breadcrumbs-top">
          <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">匯入產品類別</li>
            </ol>
          </div>
        </div>
      </div>
            ...
            <div class="card">
              ...
              <div class="card-body collapse in">
                <div class="card-block padding-lr-20">
                  <form class="form form-horizontal" action="products-category-import-submit.php" method="post" enctype="multipart/form-data">
                    <div class="form-body padding-top-40">
                      <div class="form-group row">
                        <label class="col-md-3 label-control" for="projectinput2">選擇級別</label>
                        <div class="col-md-9">                          						  <select id="projectinput2" name="rootOptionSelect" class="form-control">
                            <? 							  echo '<option name="root" value="selected">* No Parent Category</option>';															  							  print_category_optionlist($ProductRoot,$ProductLevel);							?>
                          </select>
                        </div>
                      </div>
                      <div class="form-group row">
