...
<div class="app-content content container-fluid">
  <div class="content-wrapper">
    ...
    <div>
      <button type="button" class="btn btn-info mr-1 mb-1" onClick="location.href='products-edit.php';"><i class="icon-plus4"></i> 新增產品</button>
  <!--<button type="button" class="btn btn-info mr-1 mb-1" onclick="location.href='products-import.php';"><i class="icon-plus4"></i> 匯入產品</button>
  <button type="button" class="btn btn-info mr-1 mb-1" onclick="location.href='products-specifications-import.php';"><i class="icon-plus4"></i> 匯入產品規格</button>
      <button type="button" class="btn btn-info mr-1 mb-1" onclick="location.href='download-format.php';"><i class="icon-plus4"></i> 3D 下載格式名稱</button>-->
    </div>
              ...
              <div class="card-body collapse in">
                <div class="card-block card-dashboard padding-lr-20">
                  <table class="table table-striped table-bordered bootstrap-3">
					...
					// list for product category  					
					mysql_data_seek($queryResult,0);
					while($temp = mysql_fetch_assoc($queryResult))
					{		
						$rule = get_Products_Select_Rule('PROD_CAT_ID',$temp['id']);						
						$queryProdResult = get_Products_List($rule);
						// list for product list by product category id
						while($tempProd = mysql_fetch_assoc($queryProdResult))
						{
							...
							<td><div class="card-block">
								<div class="icheck1">
								  <fieldset>
									<input type="checkbox" name="status_:ProductId" :CHECKED  disabled />
								  </fieldset>
								</div>
							  </div></td>
							  <td>:CREATE_DATE</td>
							<td><div class="btn-group" role="group" aria-label="Basic example"> 
								...
								<!--<button type="button" class="btn btn-info" name = "specification"  onClick="location.href=\'specifications.php?id=:PROD_CAT_ID&prod_id=:ProductId\';">產品規格</button>-->
