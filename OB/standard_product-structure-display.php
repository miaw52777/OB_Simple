...
//	var_dump(($_POST));
	...
	if(isset($_POST['view3d_item_key']))	{		$item_key = $_POST['view3d_item_key'];	}	else	{		$item_key = $Result_3D['item_key'];		}
...
{		
	...
	{					
		...
		var itemArr = modelArray[1].split("_");												var itemKey = modelArray[1];		var cad_item_key = document.getElementById("cad_item_key");		cad_item_key.value = itemKey;			var view3d_item_key = document.getElementById("view3d_item_key");		view3d_item_key.value = itemKey;	
...
{		
	...
	var cad_item_key = document.getElementById("cad_item_key");						 			cad_item_key.value = item_key;		var view3d_item_key = document.getElementById("view3d_item_key");						 			view3d_item_key.value = item_key;	
} 
...
<div class="app-content content">
  <div class="content-wrapper">
    <!--<div class="main-menu menu-static menu-light menu-accordion menu-shadow">
      <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
		  ...
		  <!-- <li class="nav-item"><a href="standard_form.php"><i class="icon-mail6"></i><span class="menu-title">Enquiry</span></a> </li>          <li class="nav-item"><a href="http://www.fonray.com/en/about.html"><i class="icon-office"></i><span class="menu-title">About</span></a> </li>         <li class="nav-item"><a href="http://www.fonray.com/en/news.html"><i class="icon-news"></i><span class="menu-title">News</span></a> </li>         <li class="nav-item"><a href="http://www.fonray.com/en/certificate.html"><i class="icon-trophy3"></i><span class="menu-title">Certificates </span></a> </li>
    ...
    <div class="content-body">
	  ...
	  <div><h4 class="card-title"><? echo $Product_name; ?> </h4></div>
      <!--<div id="image-gallery" class="card">
        <div class="card-header">
          <h4 class="card-title"><? echo $Product_name; ?> </h4>
              ...
              <div class="card-block">
                ...
                <div class="card-text">
                  <div class="table-responsive">
                      ...
                      <form class="form form-horizontal" action="standard_product-structure-display.php" method="post">
                        <tbody>
						  ...
						  {																
							...
							echo '<input type="hidden" name="prod_id" value="'.$prod_id.'"/>';																					echo '<input type="hidden" name="view3d_item_key" id="view3d_item_key" value="'.$item_key.'"/>';														
						?>
                          <tr>
                            <th scope="row"></th>
                    ...
                    </table>										<div class="padding-top-30 padding-lr-20 padding-bottom-20 ">                      <button type="button" class="ui-button ui-widget ui-corner-all btn-danger mt-1"><i class="icon-heart"></i> Add favorite products</button>                      <button class="ui-button ui-widget ui-corner-all btn-success mt-1" onclick="AddEnquiry('<? echo $_COOKIE['prod_list']; ?>','<? echo $prod_id; ?>');"><span class="ui-icon icon-mail6"></span> Add enquiry</button>                    <button class="ui-button ui-widget ui-corner-all btn-success mt-1"  onclick="location.href='standard_form.php'"><span class="ui-icon icon-list2"></span> View enquiry</button> </div>
                  </div>
                </div>
              </div>
            </div>
							...
							<?				
								if(isset($_POST['view3d_item_key']))								{									$item_key = $_POST['view3d_item_key'];								}		
								echo '<input type="hidden" name="id" value="'.$id.'"/>';
								...
								echo '<input type="hidden" name="item_key" id="cad_item_key" value="'.$item_key.'"/>';
