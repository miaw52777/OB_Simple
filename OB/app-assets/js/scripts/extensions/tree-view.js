...
$(document).ready(function(){
    ...
    $('#custom-icon-treeview').treeview({
        color: "#967ADC",
        expandIcon: 'icon-ios-arrow-forward',
        collapseIcon: 'icon-ios-arrow-down',
        nodeIcon: 'icon-bookmark2',
        data: defaultData
    });
    ...
    $('#tags-badge-treeview').treeview({
        color: "#967ADC",
        expandIcon: "icon-stop22",
        collapseIcon: "icon-checkbox-unchecked",
        nodeIcon: "icon-head",
        showTags: true,
        data: defaultData
    });
