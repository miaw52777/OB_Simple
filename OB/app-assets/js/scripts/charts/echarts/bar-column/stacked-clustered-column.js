                ...
                series : [
                    {
                        ...
                        type:'bar',
                        itemStyle: {normal: {color:'rgba(153,184,152,1)', label:{show:true}}},
                        data:[40,155,95,75, 0]
                    },
                    {
                        name:'ECharts2 - 2w Data',
                        type:'bar',
                        itemStyle: {normal: {color:'rgba(254,206,168,1)', label:{show:true,textStyle:{color:'#27727B'}}}},
                        data:[100,200,105,100,156]
                    },
                    {
                        name:'ECharts2 - 20w Data',
                        type:'bar',
                        itemStyle: {normal: {color:'rgba(255,132,124,1)', label:{show:true,textStyle:{color:'#E87C25'}}}},
                    ...
                    },
                    {
                        ...
                        type:'bar',
                        xAxisIndex:1,
                        itemStyle: {normal: {color:'rgba(153,184,152,0.7)', label:{show:true,formatter:function(p){return p.value > 0 ? (p.value +'\n'):'';}}}},
                    ...
                    },
                    {
                        ...
                        type:'bar',
                        xAxisIndex:1,
                        itemStyle: {normal: {color:'rgba(254,206,168,0.7)', label:{show:true}}},
