/*=========================================================================================
    File Name: legend-plotted-cities.js
    Description: legend plotted cities mapael vector map example
    ----------------------------------------------------------------------------------------
...
// Legend plotted cities mapael vector map
// ---------------------------------------

$(window).on("load", function(){

    $(".legend-plotted-cities").mapael({
        map: {
